...
for exp in exps:
    ...
    for t in order:
        ...
        cmap,norm,__=plot_quarter_circular_cdf_from_table(cdf3, ax[0,0], corner=corner,
                     ...
                     cmap="Reds")
        cmap,norm,__=plot_quarter_circular_cdf_from_table(cdf3, ax[1,0], corner=corner,
                     origin_year=origin_year,
                     per_year=per_year,
                     cdf_last=0.90,
                     add_colorbar=False,
                     linestyle=line_styles[t],
                     title="90% Chance (Likely)",
                     cmap="Reds")
            
        cmap,norm,__=plot_quarter_circular_cdf_from_table(cdf2, ax[0,1],  corner=corner,
                     origin_year=origin_year,
                     per_year=per_year,
                     cdf_last=0.66,
                     add_colorbar=False,
                     linestyle=line_styles[t],
                     title="66% Chance (Likely), Filltered",
                     cmap="Reds")
        cmap,norm,__=plot_quarter_circular_cdf_from_table(cdf2, ax[1,1], corner=corner,
                     ...
                     add_colorbar=False,
                     linestyle=line_styles[t],
                     title="90% Chance (Likely), Filltered",
                     cmap="Reds")          
...
sm.set_array([])
fig.subplots_adjust(bottom=0.12,wspace=0.00,left=0.01,right=0.98)
...
plt.savefig("figures/halo_supp.png", bbox_inches="tight")
plt.close(fig)
